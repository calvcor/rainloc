...
class GFSWorker:
    ...
    def get_metadata(self) -> Dict[str, Any]:
        ...
        if self.current_manifest:
            ...
            meta["is_complete"] = (max_step >= max_target)
            meta["is_updating"] = self._is_syncing or (max_step < max_target and meta.get("status") != "complete")
            return meta
    ...
    def get_image_path(self, step: int, layer_type: str = "total") -> Optional[Path]:
        """Devuelve la ruta al archivo PNG del paso y tipo solicitados si existe."""
    ...
    def get_value_at(self, lat: float, lon: float, step: int, layer_type: str = "total") -> Optional[float]:
        """Consulta instantánea (0ms) en la matriz NumPy en memoria o disco."""
    ...
    async def sync_gfs_forecast(self, max_steps: Optional[int] = None):
        ...
        async with self._sync_lock:
            ...
            try:
                ...
                # Si reanudamos, intentar cargar el último .npy disponible para cálculo de intervalos
                if available_steps:
                ...
                for step in steps_to_process:
                    ...
                    np.save(interval_npy, interval_3h)
